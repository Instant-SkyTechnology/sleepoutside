import{l as s,b as n}from"./utils-DuuMH0ky.js";import{P as l}from"./ProductData-CJRSSPp0.js";class d{constructor(e,r,t){this.category=e,this.dataSource=r,this.parentElement=t}async init(){const e=await this.dataSource.getData(this.category);if(!e.length){this.parentElement.innerHTML="<li>No products found.</li>";return}const r=e.map(t=>`
